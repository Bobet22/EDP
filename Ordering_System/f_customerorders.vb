Public Class f_customerorders

    Private Sub f_customerorders_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        lv1_users()
        opencon()
    ...
    Sub lv1_users()
        ...
        ListView1.Columns.Add("ORDER ID", 130)
        ListView1.Columns.Add("ORDERDATE", 200)
